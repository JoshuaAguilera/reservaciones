...
class FilesTemplate {
  ...
  static String getHTML(Cotizacion cotizacion, List<Habitacion> rooms) {
...
<![endif]--> <style type="text/css">#outlook a { padding:0;}.es-button { mso-style-priority:100!important; text-decoration:none!important;}a[x-apple-data-detectors] { color:inherit!important; text-decoration:none!important; font-size:inherit!important; font-family:inherit!important; font-weight:inherit!important; line-height:inherit!important;}.es-desk-hidden { display:none; float:left; overflow:hidden; width:0; max-height:0; line-height:0; mso-hide:all;}@media only screen and (max-width:600px) {p, ul li, ol li, a { line-height:150%!important } h1, h2, h3, h1 a, h2 a, h3 a { line-height:120% } h1 { font-size:36px!important; text-align:left } h2 { font-size:26px!important; text-align:left } h3 { font-size:20px!important; text-align:left } .es-header-body h1 a, .es-content-body h1 a, .es-footer-body h1 a { font-size:36px!important; text-align:left }
 ...
 <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;color:#131313;font-size:14px"><b>Habitación Deluxe doble, vista a la reserva 🏞️</b></p>''';
    ...
    if (!(cotizacion.esGrupo ?? false)) {
      emailHtmlPart1 +=
          '''<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;color:#131313;font-size:14px">No. de cotización: <strong>${cotizacion.folioPrincipal!}</strong></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;color:#131313;font-size:14px"><strong>Plan Todo Incluido</strong><br>''';
      for (var element in rooms) {
        emailHtmlPart1 += '''
      <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;color:#131313;font-size:14px"><u>${Utility.getOcupattionMessage(element)}</u><br><strong>Total por noche:</strong> ${Utility.formatterNumber(((element.totalVR ?? 1) / (element.tarifaXDia?.length ?? 1)))}&nbsp;&nbsp;<br><strong>Total por estancia:</strong> ${Utility.formatterNumber(element.totalVR ?? 0)}</strong></p>
      ''';
      }
      ...
      for (var element in rooms) {
        emailHtmlPart1 += '''
      <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;color:#131313;font-size:14px"><u>${Utility.getOcupattionMessage(element)}</u><br><strong>Total por noche:</strong> ${Utility.formatterNumber(((element.totalVPM ?? 1) / (element.tarifaXDia?.length ?? 1)))}&nbsp;&nbsp;<br><strong>Total por estancia:</strong> ${Utility.formatterNumber(element.totalVPM ?? 0)}</p>
      ''';
      }
    }
 ...
 <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;Margin-bottom:15px;color:#333333;font-size:12px">Manzana 8 lote 3,&nbsp;Bahía Arrocito, CP 70988 Bahias de Huatulco, Oax</p></td> </tr>
