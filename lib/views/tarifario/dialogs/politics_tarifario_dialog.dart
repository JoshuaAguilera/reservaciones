...
class PoliticsTarifarioDialog extends StatefulWidget {
  const PoliticsTarifarioDialog({super.key, required this.policy});

  final PoliticaTarifario? policy;
                ...
                child: Column(
                  children: [
                    TitlePage(
                      ...
                      subtitle:
                          "Ultima modificación: ${DateHelpers.getStringDate(data: widget.policy?.updatedAt)}",
                    ),
                    Divider(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Buttons.commonButton(
                    ...
                    sizeText: 12.5,
                    onPressed: () async {
                      PoliticaTarifario savePolicy = PoliticaTarifario(
                        idInt: widget.policy?.idInt,
                        id: widget.policy?.id,
                      ...
                      // bool responseSavePolicy = await TarifaBaseService()
                      //     .saveData(savePolicy);
