...
class _HabitacionFormState extends ConsumerState<HabitacionForm> {
                ...
                child: Column(
                  ...
                  children: [
                    CustomWidgets.titleFormPage(
                      ...
                      optionPage:
                          (!showSwitchCashSeason || typeQuote == "grupal")
                              ? null
                      ...
                      data: (politicas) {
                        ...
                        return tarifaProvider.when(
                          data: (list) {
                            ...
                            if (!startflow) {
                              isEditing = habitacionProvider
                                  .tarifasXHabitacion!.isNotEmpty;
                              if (list.isEmpty) {
                                Future.delayed(
                                  600.ms,
                                  () => showSnackBar(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: CustomWidgets.sectionButton(
                                        ...
                                        listModes: (DateHelpers.revisedLimit(
                                                  DateTime.parse(
                                                      _fechaEntrada.text),
                                                  DateTime.parse(
                                                      _fechaSalida.text),
                                            ...
                                            ? selectedMode
                                            : _selectedModeRange,
                                        modesVisual: (DateHelpers.revisedLimit(
                                                  DateTime.parse(
                                                      _fechaEntrada.text),
                                                  DateTime.parse(
                                                      _fechaSalida.text),
                                ...
                                if (!changedDate)
                                  SizedBox(
                                    child: DiasListView(
                                      ...
                                      isCalendary: (DateHelpers.revisedLimit(
                                                DateTime.parse(
                                                    _fechaEntrada.text),
                                                DateTime.parse(
                                                    _fechaSalida.text),
                                          ...
                                          ? selectedMode.first
                                          : false,
                                      isTable: (DateHelpers.revisedLimit(
                                                DateTime.parse(
                                                    _fechaEntrada.text),
                                                DateTime.parse(
                                                    _fechaSalida.text),
                                      ...
                                      isCheckList: (DateHelpers.revisedLimit(
                                                DateTime.parse(
                                                    _fechaEntrada.text),
                                                DateTime.parse(
                                                    _fechaSalida.text),
              ...
              data: (list) {
                return SummaryControllerWidget(
                  ...
                  onSaveQuote: () {
                    ...
                    //       .editItem(habitacionProvider.id, habitacionProvider);
                    // } else {
                    //   ref
                    //       .read(habitacionesProvider.notifier)
  ...
  void getTarifasSelect(
    ...
    List<Tarifa> tarifasProvisionales,
...
void showDialogRateManager(
  ...
  //     } else {
  //       if (!applyFreeTariff) {
  //         if (withoutAction && list.first!.id == alternativeGrupTariff?.id) {
